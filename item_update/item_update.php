...
$product_fields_info = request('crm.product.get', $url, ['id' => $product_id]);
...
file_put_contents(__DIR__ . '/log.txt', 'id товара: ' . $product_id . "<br/>". 'id категории товара: ' . $product_category_id . "<br/>" . 'id ведущего менеджера: ' . $lead_manager_id . date('Y-m-d H:i:s') . PHP_EOL, FILE_APPEND);
